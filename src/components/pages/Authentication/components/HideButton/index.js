...
export class HideButton {
  constructor (onClick) {
    this.showState = true
    this.element = new Stylable(new Wrap(new Clickable(new Raw(`<svg class="pages-hide-button-svg" width="30" height="30" viewBox="0 0 36 29" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg>`),
    {
      ...
      wrap: (container) => {
        ...
        newContainer.className = 'pages-hide-button'
